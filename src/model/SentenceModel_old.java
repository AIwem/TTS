 ...
 *
 */
public class SentenceModel_old{
	 ...
	 */
	private ArrayList<Word_old> subjects = new ArrayList<Word_old>();
	
	/**
	 * The only verb of this sentence.
	 */
	private Word_old verb;
	
	/**
	 * object(s) of this sentence, if any.
	 */
	private ArrayList<Word_old> objects = new ArrayList<Word_old>();
	
	/**
	 * adverb(s) of this sentence, if any.
	 */
	private ArrayList<Word_old> adverbs = new ArrayList<Word_old>();
	
	public SentenceModel_old(String originalSentence){
		this.NLSentence = originalSentence;			
		this.subjects = new ArrayList<Word_old>();
		this.objects = new ArrayList<Word_old>();
		this.adverbs = new ArrayList<Word_old>();
	}
	
	public SentenceModel_old(String originalSentence, SceneModel sceneModel){
		this.NLSentence = originalSentence;
	...
	public void setSubjects(ArrayList<Word_old> subjects) {
		this.subjects = subjects;
	}
	
	public void setVerb(Word_old verb) {
		this.verb = verb;
	}
	...
	public void setVerb(String verb) {
		this.verb = new Word_old(verb, DependencyRelationType.ROOT, this);
	}
	
	public void setObjects(ArrayList<Word_old> objects) {
		this.objects = objects;
	}
	
	public void setAdverbs(ArrayList<Word_old> adverbs) {
		this.adverbs = adverbs;
	}
	
	public void setPrerparedSentencePart(Word_old newSentencePart){		
	...
	public Word_old getArg0SentencePart(){
	...
	public Word_old getArg1SentencePart(){
	...
	public Word_old getArg2SentencePart() {
	...
	public Word_old getArg3SentencePart() {		
	...
	public Word_old getArg4SentencePart() {		
	...
	public Word_old getArg5SentencePart() {
	...
	public ArrayList<Word_old> getSubjects() {
		return subjects;
	}
	 ...
	 */
	public Word_old getFirstSubject(){
	...
	public ArrayList<Word_old> getObjects() {
		return objects;
	}
	 ...
	 */
	public Word_old getFirstObject(){
	...
	public ArrayList<Word_old> getAdverbs() {
		return adverbs;
	}
	 ...
	 */
	public Word_old getFirstAdverb(){	
	...
	public ArrayList<Word_old> getSentencePartsWithSourceNumber(int number) {
		ArrayList<Word_old> allPart = new ArrayList<Word_old>();
	 ...
	 * @param subject
	 */
	public void addSingleSubject(Word_old subject) {
		if(subject == null){
	...
	public void addSubjects(String... subjects) {
		...
		for(String sbj:subjects)
			if(sbj != null)
				this.subjects.add(new Word_old(sbj, DependencyRelationType.SBJ, this));			
	 ...
	 * @param object
	 */
	public void addSingleObject(Word_old object) {
		if(object == null){
	...
	public void addObjects(String... objects) {
		...
		for(String obj:objects)
			if(obj!= null)
				this.objects.add(new Word_old(obj, DependencyRelationType.OBJ, this));		
	}
	 ...
	 * @param adverb
	 */	
	public void addSingleAdverb(Word_old adverb) {
		if(adverb == null){
	...
	public void addAdverbs(String... adverbs) {
		...
		for(String adv:adverbs)
			if(adv!= null)
				this.adverbs.add(new Word_old(adv, DependencyRelationType.ADVRB, this));
	}
	...
	public Word_old getSentencePart(Node partNode) {		
	...
	public Word_old getSentencePart(SemanticTag semanticTag){
		if(semanticTag == null)
			return null;
	...
	public Word_old getSentencePart(MainSemanticTag mainSemanticTag) {
	...
	public Word_old getSentencePart(SubSemanticTag subSemanticArg) {	
		if(subSemanticArg == null)
			return null;
	 ...
	 */
	public void arrageSentenceParts(String NLSentence, ArrayList<Word_old> senParts) {
		
		for(Word_old part:senParts){
			if(part == null)
				continue;	
